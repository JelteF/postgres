...
#undef MAX_ERRLEN
				 ...
				 * don't call pqFinishParsingMessage here because we already
				 * trace this message inside pg_fe_sendauth (since we need to
				 * trace it before sending the response.
				 */
				conn->inStart = conn->inCursor;
