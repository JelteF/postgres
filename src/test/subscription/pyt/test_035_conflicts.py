...
def test_conflicts(create_pg):
    ...
    # The whole scenario runs inside that database; the drops at the end must
    # not, so the default is cleared again before them.
    subscriber.default_connection_options = {"dbname": "clt_ts_test"}
    subscriber.sql(
    ...
    # be.
    subscriber.sql("CREATE TABLE user_tbl (i int)")
    ...
    subscriber.default_connection_options = {}
