...
def test_column_list(create_pg):
    ...
    publisher.sql("INSERT INTO tab1 VALUES (1, 2, 3); INSERT INTO tab1 VALUES (4, 5, 6)")
    publisher.sql("INSERT INTO tab3 VALUES (1, 2, 3); INSERT INTO tab3 VALUES (4, 5, 6)")
    publisher.sql(
    ...
    publisher.sql("INSERT INTO tab1 VALUES (2, 3, 4); INSERT INTO tab1 VALUES (5, 6, 7)")
    publisher.sql("INSERT INTO tab3 VALUES (2, 3, 4); INSERT INTO tab3 VALUES (5, 6, 7)")
    publisher.sql(
    ...
    publisher.sql("UPDATE tab2 SET c = 5 where a = 1; UPDATE tab2 SET b = 'xyz' where a = 2")
    publisher.wait_for_catchup("sub1")
    assert subscriber.sql("SELECT * FROM tab2 ORDER BY a") == [
        (1, "abc"),
        (2, "xyz"),
    ...
    publisher.sql("INSERT INTO tab5 VALUES (3, 33, 333, 3333); INSERT INTO tab5 VALUES (4, 44, 444, 4444)")
    publisher.wait_for_catchup("sub1")
    ...
    publisher.sql("INSERT INTO tab6 VALUES (2, 33, 444, 5555); UPDATE tab6 SET b = b * 2, c = c * 3, d = d * 4")
    publisher.wait_for_catchup("sub1")
    ...
    publisher.sql("ALTER TABLE tab6 DROP CONSTRAINT tab6_pkey; ALTER TABLE tab6 ADD PRIMARY KEY (b)")
    subscriber.sql("ALTER TABLE tab6 DROP CONSTRAINT tab6_pkey; ALTER TABLE tab6 ADD PRIMARY KEY (b)")
    subscriber.sql("ALTER SUBSCRIPTION sub1 REFRESH PUBLICATION")
    subscriber.wait_for_subscription_sync()

    publisher.sql("INSERT INTO tab6 VALUES (3, 55, 666, 8888); UPDATE tab6 SET b = b * 2, c = c * 3, d = d * 4")
    publisher.wait_for_catchup("sub1")
    assert subscriber.sql("SELECT * FROM tab6 ORDER BY a") == [
        (1, 88, None, None),
        (2, 132, None, None),
    ...
    publisher.sql("INSERT INTO tab7 VALUES (2, 33, 444, 5555); UPDATE tab7 SET b = b * 2, c = c * 3, d = d * 4")
    publisher.wait_for_catchup("sub1")
    ...
    publisher.sql("ALTER TABLE tab7 DROP CONSTRAINT tab7_pkey; ALTER TABLE tab7 ADD PRIMARY KEY (a, b)")
    publisher.sql("INSERT INTO tab7 VALUES (3, 55, 666, 7777); UPDATE tab7 SET b = b * 2, c = c * 3, d = d * 4")
    publisher.wait_for_catchup("sub1")
    assert subscriber.sql("SELECT * FROM tab7 ORDER BY a") == [
        (1, 88, None, None),
        (2, 132, None, None),
    ...
    publisher.sql("INSERT INTO test_part_a VALUES (2, 5); INSERT INTO test_part_a VALUES (7, 6)")
    publisher.wait_for_catchup("sub1")
    ...
    publisher.sql("INSERT INTO test_part_b VALUES (2, 3); INSERT INTO test_part_b VALUES (7, 4)")
    publisher.wait_for_catchup("sub1")
    ...
    publisher.sql("INSERT INTO test_part_c VALUES (3, 7, 8); INSERT INTO test_part_c VALUES (4, 9, 10)")
    publisher.wait_for_catchup("sub1")
    ...
    publisher.sql("INSERT INTO test_part_c VALUES (1, 3, 5); INSERT INTO test_part_c VALUES (2, 4, 6)")
    publisher.wait_for_catchup("sub1")
    assert subscriber.sql("SELECT * FROM test_part_c ORDER BY a, b") == [
        (1, None, None),
        (2, 4, None),
    ...
    publisher.sql("INSERT INTO test_root VALUES (2, 3, 4); INSERT INTO test_root VALUES (11, 21, 31)")
    publisher.wait_for_catchup("sub1")
    ...
    publisher.sql("UPDATE test_oldtuple_col SET a = 2; DELETE FROM test_oldtuple_col")
