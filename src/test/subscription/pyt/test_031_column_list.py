...
def test_column_list(create_pg):
    ...
    publisher.sql("UPDATE tab4 SET b = 'blue', c = c * 2, d = d || ' updated' where a = 1")
    publisher.sql("UPDATE tab4 SET b = 'red', c = c * 2, d = d || ' updated' where a = 2")
    publisher.wait_for_catchup("sub1")
    ...
    subscriber.sql(f"CREATE SUBSCRIPTION sub1 CONNECTION '{connstr}' PUBLICATION pub2, pub3")
