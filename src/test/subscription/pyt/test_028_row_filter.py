...
def test_row_filter(create_pg):
    ...
    publisher.sql("INSERT INTO schema_rf_x.tab_rf_x (x) VALUES (0), (5), (10), (15), (20)")
    ...
    publisher.sql("CREATE PUBLICATION tap_pub_2 FOR TABLE tab_rowfilter_2 WHERE (c % 3 = 0)")
    ...
    publisher.sql("CREATE PUBLICATION tap_pub_not_used FOR TABLE tab_rowfilter_1 WHERE (a < 0)")
    publisher.sql("CREATE PUBLICATION tap_pub_4a FOR TABLE tab_rowfilter_4 WHERE (c % 2 = 0)")
    ...
    publisher.sql("CREATE PUBLICATION tap_pub_5b FOR TABLE tab_rowfilter_partition WHERE (a > 10)")
    publisher.sql(
    ...
    publisher.sql("CREATE PUBLICATION tap_pub_virtual FOR TABLE tab_rowfilter_virtual WHERE (y > 10)")
    ...
    subscriber.sql("ALTER SUBSCRIPTION tap_sub REFRESH PUBLICATION WITH (copy_data = true)")
