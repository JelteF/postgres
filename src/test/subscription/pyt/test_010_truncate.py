...
def test_truncate(create_pg):
    ...
    subscriber.sql(f"CREATE SUBSCRIPTION sub5_1 CONNECTION '{connstr}' PUBLICATION pub5")
    subscriber.sql(f"CREATE SUBSCRIPTION sub5_2 CONNECTION '{connstr}' PUBLICATION pub5")
    subscriber.wait_for_subscription_sync()
