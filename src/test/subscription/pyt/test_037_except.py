...
def test_except(create_pg):
    ...
    assert subscriber.sql("SELECT count(*) FROM child1") == 10, "check replicated inserts"
    ...
    subscriber.sql("TRUNCATE TABLE tab1; DROP TABLE parent, parent1, child, child1, tab2")
    publisher.sql("DROP PUBLICATION tap_pub")
    publisher.sql("TRUNCATE TABLE tab1; DROP TABLE parent, parent1, child, child1, tab2")
    ...
    publisher.sql("DROP PUBLICATION tap_pub2; TRUNCATE tab1")
    ...
    publisher.sql("CREATE PUBLICATION tap_pub2 FOR ALL TABLES; INSERT INTO tab1 VALUES(1)")
